...
TEST_CASE("Circuit breaker - opens after threshold failures", "[circuit_breaker]")
{
    ...
    shield::circuit_breaker cb("test", MAX_FAILURE_COUNT, std::chrono::seconds(10));
...
{
    const int MAX_FAILURE_COUNT = 2;
    shield::circuit_breaker cb("test", MAX_FAILURE_COUNT, std::chrono::milliseconds(100));
...
{
    const int MAX_FAILURE_COUNT = 2;
    shield::circuit_breaker cb("test", MAX_FAILURE_COUNT, std::chrono::milliseconds(50));
...
TEST_CASE("Circuit breaker - success resets failure count", "[circuit_breaker]")
{
    ...
    shield::circuit_breaker cb("test", MAX_FAILURE_COUNT, std::chrono::seconds(1));
